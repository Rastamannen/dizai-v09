...
export default function App() {
  ...
  const renderTranscript = () => {
    ...
    const refWords = exercises[exerciseIdx].text.split(/\s+/);
          ...
          <span
            ...
            style={{
              background: highlight.includes(i)
                ? "#FFD580"
                : "inherit",
              color: highlight.includes(i)
                ? "#D1495B"
                : "inherit",
              padding: highlight.includes(i) ? "2px 4px" : undefined,
              borderRadius: highlight.includes(i) ? "6px" : undefined,
              marginRight: 3,
            }}
          >
            {w + " "}
    ...
    <div className="dizai-root">
      ...
      <div className="main-content">
        ...
        <div className="transcript">
          <b>Transcript:</b> {renderTranscript()}
        </div>
        <div className={
          feedback.startsWith("Perfect") ? "feedback feedback-ok"
            : feedback.startsWith("Almost") ? "feedback feedback-warn"
            : feedback.startsWith("Try") ? "feedback feedback-err"
            : "feedback"
        }>
          {feedback}
        </div>
